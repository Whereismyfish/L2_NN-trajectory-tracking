...
function [dy,tao_u,tao_r,e_u,e_r,dist1,dist3,x_d,y_d,Feu,Fer,x_e,y_e,psi_e] = AUV_L2_noNN(t,y,m11,m22,m33,...
...
tao_u = m11*(- (1+1/4/ganma/ganma)*e_u - f_u - k1*e_u);
tao_r = m33*(- (1+1/4/ganma/ganma)*e_r - f_r - k2*e_r);
...
% omiga_e1 = 0.3 + (1.3-0.3)*rand;dist1 = n1*sin(omiga_e1*t);
% omiga_e2 = 0.3 + (1.3-0.3)*rand;dist2 = n2*sin(omiga_e2*t);
% omiga_e3 = 0.3 + (1.3-0.3)*rand;dist3 = n3*sin(omiga_e3*t);
