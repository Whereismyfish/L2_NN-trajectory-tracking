...
[T1,Y1] = ode45(@(t,y) AUV_NN_L2NN(t,y,m11,m22,m33,Xu,Yv,Nr,Xuu,Yvv,Nrr,k01,k02,k1,k2,k3,k4,k5,k6,delta,const_t,ganma,n1,n2,n3),Tspan,IC,Error);
[T2,Y2] = ode45(@(t,y) AUV_NN_observer(t,y,m11,m22,m33,Xu,Yv,Nr,Xuu,Yvv,Nrr,k01,k02,k1,k2,k3,k4,k5,k6,delta,const_t,n1,n2,n3,L0),Tspan,IC1,Error);
kb = 7;
...
[~,tao_u,tao_r,e_u,e_r,dist1,dist3,x_d,y_d,Feu,Fer,x_e,y_e,psi_e] = cellfun(@(t,y) AUV_NN_L2NN(t,y.',m11,m22,m33,...
    Xu,Yv,Nr,Xuu,Yvv,Nrr,k01,k02,k1,k2,k3,k4,k5,k6,delta,const_t,ganma,n1,n2,n3),num2cell(T1),num2cell(Y1,2),'uni',0);

[~,tao_u1,tao_r1,e_u1,e_r1,dist11,dist21,dist31,x_d1,y_d1,Feu1,Fer1,x_e1,y_e1,psi_e1,est_d1,est_d2,est_d3] = cellfun(@(t,y) AUV_NN_observer(t,y.',m11,m22,m33,...
    Xu,Yv,Nr,Xuu,Yvv,Nrr,k01,k02,k1,k2,k3,k4,k5,k6,delta,const_t,n1,n2,n3,L0),num2cell(T2),num2cell(Y2,2),'uni',0);
...
dist11 = cell2mat(dist11);dist21 = cell2mat(dist21);dist31 = cell2mat(dist31);
...
title('Trajectory tracking'),legend('Proposed','Do-based method','Desired')
